...
public class DeleteItemForm extends javax.swing.JFrame {
    ...
    private void txtIdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtIdActionPerformed
        try {
            ...
            Item item = ItemController.searchItem(txtId.getText());
            if(item!=null){
                txtName.setText(item.getDescription());
                txtAddress.setText(String.valueOf(item.getUnitPrice()));
                txtSalary.setText(String.valueOf(item.getQty()));
            }else{
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        try {
            boolean isDeleted=ItemController.deleteItem(txtId.getText());
            if(isDeleted){
